...
11 timing config:load:file:/root/.npmrc Completed in 6ms
...
18 timing config:load Completed in 35ms
19 timing npm:load:configload Completed in 35ms
...
27 timing command:run-script Completed in 162791ms
...
29 verbose pkgid auth@1.0.0
30 verbose cwd /app
31 verbose Linux 5.4.0-94-generic
32 verbose argv "/usr/local/bin/node" "/usr/local/bin/npm" "run" "dev"
33 verbose node v16.13.2
34 verbose npm  v8.1.2
35 error path /app
36 error command failed
37 error signal SIGTERM
38 error command sh -c npx nodemon server
39 verbose exit 1
